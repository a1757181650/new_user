...
*/
package com.jinglangtech.cardiy.widget;
  ...
  public void draw(Canvas canvas) {
    ...
    if (mOval) {
      ...
      if (mBorderWidth > 0) {
        ...
        if(drawRight){
          canvas.drawRect(mDrawableRect.right - mCornerRadius, mDrawableRect.top,mDrawableRect.right, mDrawableRect.bottom, mBitmapPaint);
        }
      }
    }
  }
