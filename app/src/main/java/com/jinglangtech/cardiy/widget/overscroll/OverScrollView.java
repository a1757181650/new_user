...
public class OverScrollView extends ScrollView {
    ...
    private OverAnyHeightDo mOverAnyHeightDo;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (isRecord && Math.abs(ev.getY() - mLastMotionY) > 50) {
                    return true;
                }
                break;
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_CANCEL:
            case MotionEvent.ACTION_UP:
                if (mOverAnyHeightDo != null && overScrollDistance < -180) {
                    mOverAnyHeightDo.doSomething();
                }
                mContentLayout.smoothScrollToNormal();
                overScrollTrigger();
                // 重置滑动总距离
    ...
    public void setOverAnyHeightDoListener(OverAnyHeightDo listener) {
        mOverAnyHeightDo = listener;
    }
